<?php 
    ...
    if (isset($_POST['send'])) {
        ...
        $sql = "INSERT INTO reci_list(`user_id`,`recipe_cat`,`recipe_name`,`recipe_img`,`ingredient`,`instruction`,`portion`)VALUES('$myid','$recipe_cat','$recipe_name','$recipe_img','$ingredient','$instruction','$portion')";
        //var_dump($sql);
        //exit();
        $qry = $conn->query($sql);
        //$qry->bind_param('sssssss',$myid,$recipe_cat,$recipe_name,$recipe_img,$ingredient,$instruction,$portion);
        //$qry->execute();
        if ($qry) {
